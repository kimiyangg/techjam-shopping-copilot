...
- Always recommend every turn, even when asking a clarification (a hit stops the session).
- Intent override: REPLACE contradicted slots, never append. Boundary: "no preference" locks the attribute — never re-ask.
